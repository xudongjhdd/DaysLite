...
DaysLite does not share user data with third parties.
...
Because DaysLite stores countdown data locally on the device, users should protect their device with appropriate system security settings. DaysLite does not transmit user-created countdown data over the internet.
